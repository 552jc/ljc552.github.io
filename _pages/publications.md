...
* __Generalized Telescope Conjecture__ (in progress)<br> Introduces the atomic smashing frame to generalize the Balmer frame to any presentably symmetric monoidal $\infty$-categories $\mathcal{V}$, and formulates the associated telescope conjecture. Resolves this conjecture in the settings of $\infty$-topoi and connective modules over connective $\mathbb{E}_\infty$-rings, establishes a recollement theorem in the stable setting, and introduces the Serre smashing frame.
