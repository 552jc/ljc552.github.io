...
Preprints
======
* __Dualizable additive $\infty$-categories__ (joint with [Ishan Levy](https://ishanina.github.io/) and [Vova Sosnilo](https://vova-sosnilo.com/index.html); in progress)<br> Characterizes dualizable additive $\infty$-categories as separated Grothendieck prestable $\infty$-categories satisfying AB4* and AB6, and identifies them with connective almost modules over almost connective $\mathbb{E}_{1}$-rings. Also introduces prestable motives and prestable K-theory.
* __Generalized Telescope Conjecture__ (in progress)<br> Introduces the atomic smashing frame to generalize the Balmer frame to presentably symmetric monoidal $\infty$-categories $\mathcal{V}$, and formulates the associated telescope conjecture. Resolves this conjecture in the settings of $\infty$-topoi and connective modules over connective $\mathbb{E}_\infty$-rings, establishes a recollement theorem in the stable setting, and introduces the Serre smashing frame.
